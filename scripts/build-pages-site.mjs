...
const publicFiles = [
  ...
  'gas-demo.html', 'index.html', 'media-home.css', 'media-home.js',
...
for (const directory of ['articles', 'assets']) await cp(join(root, directory), join(output, directory), { recursive: true });
